...
public class AuthorControllerTest {
    ...
    private static final String BASED_URL = "/v1/authors";
    ...
    public void testThatCreateAuthorReturnsHttpStatus201Created() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(BASED_URL)
    ...
    public void testThatCreateAuthorReturnsCreatedAuthor() throws Exception {
        ...
        ResultActions result = mockMvc.perform(MockMvcRequestBuilders.post(BASED_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
                .content(content)
        );
